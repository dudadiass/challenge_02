...
class AnimalRepository {
  final animalList = [
    ...
    AnimalModel(
      ...
      galleryImages: [
        "assets/images/pets/dogs/siberian_husky/siberian_husky_01.png",
    ...
    AnimalModel(
      ...
      about:
          "She is shy at first, but will warm up when she's comfortable. She is not a ranch dog that guards animals and property as she whould rather be with her people; but she is comfortable around animals. She plays well with other dogs.",
      mainImage: "assets/images/pets/dogs/pug/pug_06.png",
      colour: Colors.orange.shade200,
      galleryImages: [
        "assets/images/pets/dogs/pug/pug_01.png",
        "assets/images/pets/dogs/pug/pug_02.png",
        "assets/images/pets/dogs/pug/pug_03.png",
        "assets/images/pets/dogs/pug/pug_04.png",
        "assets/images/pets/dogs/pug/pug_05.png",
      ],
    ),
  ];
}
